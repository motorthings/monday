<!--
  ...
  Fetched: 2026-06-06T22:37:46.680460+00:00
  Platform: monday
-->
...
Ask our AI assistant any question about the monday API and get an instant answer. 
...
The monday GraphQL API is part of the [monday apps framework](https://developer.monday.com/apps/docs/intro). It is an application layer that allows apps to read and update data inside a monday.com account. It supports operations boards, items, column values, users, workspaces, and more.
...
**Admins** and **members** have access to their own [API tokens](https://developer.monday.com/api-reference/docs/authentication#accessing-api-tokens). **Guests** cannot access an API key but can utilize API features through other authentication methods, like OAuth or a shortLivedToken.
...
The monday.com API is built with GraphQL, a flexible query language that allows you to return as much or as little data as you need. GraphQL is an application layer that parses the query you send it and returns (or changes) data accordingly. To learn more about the fundamental GraphQL components, check out our [GraphQL overview](https://developer.monday.com/api-reference/docs/introduction-to-graphql)!
